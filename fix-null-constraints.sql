-- NOT NULL constraint'leri kaldır

-- User Progress tablosu için NOT NULL constraint'leri kaldır
...
-- User Entries tablosu için NOT NULL constraint'leri kaldır
ALTER TABLE user_entries 
ALTER COLUMN t0percent DROP NOT NULL,
ALTER COLUMN t1percent DROP NOT NULL,
ALTER COLUMN t2percent DROP NOT NULL,
ALTER COLUMN t3percent DROP NOT NULL,
ALTER COLUMN t4percent DROP NOT NULL,
ALTER COLUMN t5percent DROP NOT NULL,
ALTER COLUMN t6percent DROP NOT NULL,
ALTER COLUMN t7percent DROP NOT NULL,
ALTER COLUMN t8percent DROP NOT NULL;

-- User Entries tablosu için veri tipini VARCHAR'a çevir
ALTER TABLE user_entries 
